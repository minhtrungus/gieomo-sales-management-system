  ...
  return (
    <>
      <Link
        ...
        className="group relative flex flex-col bg-white rounded-3xl border border-[#F0E5D8] overflow-hidden shadow-soft hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1"
      >
        {/* Image Box */}
        <div className="relative aspect-4/3 w-full bg-[#FFF8EE] overflow-hidden flex items-center justify-center">
          ...
          {product.compare_at_price && product.compare_at_price > product.price && (
            <div className="absolute top-3 right-3 z-10 bg-[#FFB98A] text-[#4A2603] text-[11px] font-extrabold px-2.5 py-0.5 rounded-full shadow-xs border border-white">
        ...
        <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-3">
          ...
          <div className="pt-3 border-t border-[#F0E5D8] flex items-center justify-between">
            ...
            <button
              ...
              className={`p-2.5 rounded-2xl transition-all shadow-xs flex items-center justify-center border ${
                isOutOfStock
