          ...
          <div>
            ...
            <div className="pt-3 border-t border-[#2F4234]/80">
              ...
              <div className="flex items-center flex-wrap gap-2.5">
                {(settings.facebookUrl || OFFICIAL_STORE_CONFIG.socialLinks.facebook) && (
                  <a
                    href={settings.facebookUrl || OFFICIAL_STORE_CONFIG.socialLinks.facebook}
                    target="_blank"
                ...
                {(settings.tiktokUrl || OFFICIAL_STORE_CONFIG.socialLinks.tiktok) && (
                  <a
                    href={settings.tiktokUrl || OFFICIAL_STORE_CONFIG.socialLinks.tiktok}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                {(settings.instagramUrl || OFFICIAL_STORE_CONFIG.socialLinks.instagram) && (
                  <a
                    href={settings.instagramUrl || OFFICIAL_STORE_CONFIG.socialLinks.instagram}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                {settings.zaloUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-8 h-8 rounded-full bg-[#293A2E] border border-[#3E5544] flex items-center justify-center text-white/90 hover:text-[#0068FF] hover:border-[#0068FF] transition-colors font-bold text-[10px]"
                    title="Zalo Mầm Mơ"
                    aria-label="Zalo Mầm Mơ"
                  >
                    Zalo
                  </a>
                )}
                {settings.youtubeUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-8 h-8 rounded-full bg-[#293A2E] border border-[#3E5544] flex items-center justify-center text-white/90 hover:text-[#FF0000] hover:border-[#FF0000] transition-colors"
                    title="YouTube Mầm Mơ"
                    aria-label="YouTube Mầm Mơ"
                  >
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
